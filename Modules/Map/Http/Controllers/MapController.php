...
class MapController extends Controller
{
    ...
    public function update(Request $request)
    {
        try {
            ...
            // ip based location
            checkSetConfig('webdeveloper.set_ip_based_location', $request->ip_based_location ? true : false);
            checkSetConfig('webdeveloper.map_show', $request->map_show ? true : false);
