...
class SettingsController extends Controller
{
    ...
    public function analyticsUpdate(Request $request)
    {
        try {
            ...
            checkSetConfig('webdeveloper.google_analytics', $request->analytics_id);
            checkSetConfig('webdeveloper.google_analytics_status', $request->is_analytics_active ? true : false);
    ...
    {
        $allEmptyProperties = array_filter(Config::get('webdeveloper'), function ($value) {
            return $value === '';
        });
        ...
        foreach ($allEmptyProperties as $property => $value) {
            ...
            if ($envValue !== null && $envValue !== '') {
                // Update the value in Config::get('webdeveloper') with the value from .env
                checkSetConfig('webdeveloper.'.$property, $envValue);
            }
        }
    }
