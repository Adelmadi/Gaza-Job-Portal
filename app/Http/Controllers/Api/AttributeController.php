...
class AttributeController extends Controller
{
    ...
    {
        $current_language = currentLanguage() ? currentLanguage() : Language::where('code', config('gazajobs.default_language'))->first();
    ...
    public function fetchTranslations()
    {
        ...
        return $this->respondWithSuccess([
            'data' => [
                'default_language_code' => config('webdeveloper.default_language'),
