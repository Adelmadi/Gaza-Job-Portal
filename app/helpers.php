...
if (! function_exists('defaultCurrencySymbol')) {
    ...
    {
        return config('webdeveloper.app_currency_symbol');
    }
}
...
if (! function_exists('changeCurrency')) {
    function changeCurrency($amount)
    {
        if (session()->has('current_currency')) {
            ...
            $symbol = config('webdeveloper.currency_symbol');
            $position = config('webdeveloper.currency_symbol_position');
        }
...
if (! function_exists('currencyExchange')) {
    function currencyExchange($amount, $from = null, $to = null, $round = 2)
    {
        ...
        $to = config('webdeveloper.currency', 'USD');
...
//         // $from = $from ?? config('webdeveloper.currency');
//         // $to = $to ?? 'USD';
...
if (! function_exists('usdAmount')) {
    function usdAmount($amount)
    {
        if (session('currency_rate')) {
            ...
            return round($amount * 1 / Currency::whereCode(config('webdeveloper.currency'))->first()->rate, 2);
        }
    }
}
...
if (! function_exists('currencyRateStore')) {
    function currencyRateStore()
    {
        if (session()->has('currency_rate')) {
            ...
            $from = config('webdeveloper.currency');
...
if (! function_exists('currentCurrencyCode')) {
    function currentCurrencyCode()
    {
        ...
        return config('webdeveloper.currency');
    }
}
...
if (! function_exists('currentCurrencySymbol')) {
    function currentCurrencySymbol()
    {
        ...
        return config('webdeveloper.currency_symbol');
    }
}
...
if (! function_exists('langDirection')) {
    ...
    {
        return currentLanguage()?->direction ?? Language::where('code', config('webdeveloper.default_language'))->value('direction');
    }
}
...
if (! function_exists('updateMap')) {
    ...
    {
        if (empty(config('webdeveloper.map_show'))) {
...
if (! function_exists('setLocationCurrency')) {
    function setLocationCurrency()
    {
        ...
        if ($ip && $ip != '127.0.0.1') {
            ...
            // Set the currency
            if (! session()->has('current_currency')) {
                $currency = Modules\Currency\Entities\Currency::where('code', $geo->currency)->first() ?? Modules\Currency\Entities\Currency::where('code', config('webdeveloper.currency'))->first();
            ...
            if (! session()->has('current_lang')) {
                ...
                if ($language) {
                    ...
                    session(['current_lang' => Language::where('code', config('webdeveloper.default_language'))->first()]);
                }
            }
...
if (! function_exists('loadDefaultLanguage')) {
    function loadDefaultLanguage()
    {
        return Cache::remember('default_language', now()->addDays(30), function () {
            return Language::where('code', config('webdeveloper.default_language'))->first();
        });
    }
}
...
if (! function_exists('loadSystemCurrency')) {
    function loadSystemCurrency()
    {
        return Cache::remember('systemCurrency', now()->addDays(30), function () {
            ...
            return Modules\Currency\Entities\Currency::where('code', config('webdeveloper.currency'))->first();
        });
    }
}
...
if (! function_exists('loadSystemLanguageCode')) {
    function loadSystemLanguageCode()
    {
        return Cache::remember('systemLanguageCode', now()->addDays(30), function () {
            return Language::where('code', config('webdeveloper.default_language'))->value('code');
        });
    }
}
