...
//  company Apis
Route::middleware(['auth:sanctum', 'api_company'])->prefix('company')->group(function () {
    //  company Dashboard Apis
    Route::controller(CompanyController::class)->group(function () {
        Route::get('/', 'company');
        Route::get('/dashboard', 'dashboard');
        Route::get('/plan', 'plan');
        Route::get('/plan-limit', 'planLimit');
        ...
        Route::get('/account-progress', 'fetchAccountProgress');
        Route::post('/account-progress', 'submitAccountProgress');
