...
Route::middleware('auth:user', 'verified')->group(function () {
    ...
    // Company Routes
    Route::controller(CompanyController::class)->prefix('company')->middleware(['company'])->name('company.')->group(function () {
...
//            Route::get('plans', 'plan')->name('plan')->middleware('user_active');
            ...
            Route::get('my-jobs', 'myjobs')->name('myjob');
            Route::get('pending-edited-jobs', 'pendingEditedJobs')->name('pending.edited.jobs');
            Route::get('create/pay-per-job', 'payPerJob')->name('job.payPerJobCreate');
            Route::post('/store/payper/job', 'storePayPerJob')->name('payperjob.store');
            Route::get('create/job', 'createJob')->name('job.create')->middleware('user_active');
            Route::post('/store/job', 'storeJob')->name('job.store');
            Route::get('/job/payment', 'payPerJobPayment')->name('payperjob.payment');
            ...
            Route::get('edit/{job:slug}/job', 'editJob')->name('job.edit');
            ...
            Route::put('/update/{job:slug}/job', 'updateJob')->name('job.update');
